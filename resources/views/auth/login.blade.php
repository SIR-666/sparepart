              ...
              <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
                <div class="col-sm-8 col-md-6 col-xl-9">
                  ...
                  <div class="row">
                    <div class="col-6 mb-2 mb-sm-0">
                      <a class="btn btn-white text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-8" href="javascript:void(0)" role="button">
                        <img src="{{ asset('dist/images/svgs/google-icon.svg')}}" alt="" class="img-fluid me-2" width="18" height="18">
                        <span class="d-none d-sm-block me-1 flex-shrink-0">Sign in with</span>Google
                      </a>
                    </div>
                    <div class="col-6">
                      <a class="btn btn-white text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-8" href="javascript:void(0)" role="button">
                        <img src="{{ asset('dist/images/svgs/facebook-icon.svg')}}" alt="" class="img-fluid me-2" width="18" height="18">
                  ...
                  <form method="POST" action={{route('authenticate')}}>
                    @csrf
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Noreg</label>
                      <input type="text" class="form-control" name="noreg" id="noreg" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-4">
